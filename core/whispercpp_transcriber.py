    ...
    def transcribe(self, audio_data: np.ndarray, 
        ...
        try:
            ...
            result = TranscriptionResult(
                ...
                speakers=[]  # Empty list for compatibility (whisper.cpp doesn't support diarization)
            )
...
class MultiModelTranscriber:
    ...
    def __init__(self, config=None):
        ...
        """
        self.config = config
        self.transcribers: Dict[str, WhisperCppTranscriber] = {}
        self.current_transcriber: Optional[WhisperCppTranscriber] = None
...
def create_transcriber(config=None, model_path: Optional[str] = None) -> WhisperCppTranscriber:
    """Create WhisperCppTranscriber instance from config or defaults.
    
    Note: This function is kept for backwards compatibility.
    For new code, use the transcriber_factory module.
    """
    return create_whispercpp_transcriber(config, model_path)
